...
GAME_SRCS = \
	g_chase.c g_cmds.c g_combat.c g_func.c g_items.c \
	g_joe_misc.c g_main.c g_misc.c g_phys.c g_save.c \
	g_spawn.c g_svcmds.c g_target.c	g_trigger.c g_utils.c \
	g_weapon.c p_client.c p_hud.c p_view.c p_weapon.c \
	q_shared.c
